#!/bin/bash
## job name
#SBATCH --job-name=31-Meta-Llama-3-70B-num-shots-9
...
/usr/bin/bash lm_eval --model hf --tasks gsm8k  --batch_size 32 --model_args pretrained=meta-llama/Meta-Llama-3-70B,parallelize=True  --output_path /data/home/beidic/zhuoming/icl/Meta-Llama-3-70B-num-shots-9 --num_fewshot 9
