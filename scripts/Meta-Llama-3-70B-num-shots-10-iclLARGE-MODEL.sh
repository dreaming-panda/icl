...
lm_eval --model hf --tasks gsm8k  --batch_size 32 --model_args pretrained=meta-llama/Meta-Llama-3-70B,parallelize=True  --output_path /data/home/beidic/zhuoming/icl/Meta-Llama-3-70B-num-shots-10 --num_fewshot 10
