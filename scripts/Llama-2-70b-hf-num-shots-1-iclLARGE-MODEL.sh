...
lm_eval --model hf --tasks gsm8k  --batch_size 32 --model_args pretrained=meta-llama/Llama-2-70b-hf,parallelize=True  --output_path /data/home/beidic/zhuoming/icl/Llama-2-70b-hf-num-shots-1 --num_fewshot 1
