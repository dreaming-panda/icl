...
lm_eval --model hf --tasks gsm8k  --batch_size 32 --model_args pretrained=meta-llama/Meta-Llama-3-70B-Instruct,parallelize=True  --output_path /data/home/beidic/zhuoming/icl/Meta-Llama-3-70B-Instruct-num-shots-7 --num_fewshot 7 --limit 0.3
