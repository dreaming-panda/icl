...
accelerate launch -m lm_eval --model hf --tasks gsm8k  --batch_size 16 --model_args pretrained=meta-llama/Llama-2-7b-hf  --output_path /data/home/beidic/zhuoming/icl/Llama-2-7b-hf-num-shots-9 --num_fewshot 9 --limit 0.1
