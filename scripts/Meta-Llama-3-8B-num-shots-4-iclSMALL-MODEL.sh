...
accelerate launch -m lm_eval --model hf --tasks gsm8k  --batch_size 16 --model_args pretrained=meta-llama/Meta-Llama-3-8B  --output_path /data/home/beidic/zhuoming/icl/Meta-Llama-3-8B-num-shots-4 --num_fewshot 4
