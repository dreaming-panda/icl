#!/bin/bash
## job name
#SBATCH --job-name=0-Llama-2-70b-hf-num-shots-0
...
/usr/bin/bash lm_eval --model hf --tasks gsm8k  --batch_size 32 --model_args pretrained=meta-llama/Llama-2-70b-hf,parallelize=True  --output_path /data/home/beidic/zhuoming/icl/Llama-2-70b-hf-num-shots-0 --num_fewshot 0
