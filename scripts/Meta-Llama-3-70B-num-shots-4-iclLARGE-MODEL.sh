#!/bin/bash
## job name
#SBATCH --job-name=26-Meta-Llama-3-70B-num-shots-4
...
/usr/bin/bash lm_eval --model hf --tasks gsm8k  --batch_size 32 --model_args pretrained=meta-llama/Meta-Llama-3-70B,parallelize=True  --output_path /data/home/beidic/zhuoming/icl/Meta-Llama-3-70B-num-shots-4 --num_fewshot 4
