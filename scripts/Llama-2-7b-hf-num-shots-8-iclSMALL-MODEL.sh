#!/bin/bash
## job name
#SBATCH --job-name=8-Llama-2-7b-hf-num-shots-8
...
/usr/bin/bash accelerate launch -m lm_eval --model hf --tasks gsm8k  --batch_size 16 --model_args pretrained=meta-llama/Llama-2-7b-hf  --output_path /data/home/beidic/zhuoming/icl/Llama-2-7b-hf-num-shots-8 --num_fewshot 8
