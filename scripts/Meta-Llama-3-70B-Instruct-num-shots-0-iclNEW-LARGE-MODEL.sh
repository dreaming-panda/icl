...
lm_eval --model hf --tasks gsm8k  --batch_size 32 --model_args pretrained=meta-llama/Meta-Llama-3-70B-Instruct,parallelize=True  --output_path /data/home/beidic/zhuoming/icl/Meta-Llama-3-70B-Instruct-num-shots-0 --num_fewshot 0 --limit 0.1
