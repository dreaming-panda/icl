...
for i, pack in enumerate(product(MODELS, SHOTS)):
    ...
    cmd1 = "lm_eval --model hf --tasks gsm8k  --batch_size 32 --model_args pretrained={},parallelize=True  --output_path {} --num_fewshot {} --limit 0.1".format(model, log_name, num_shot)
